...
import { DragonSeekingRecap } from './pages/DragonSeekingRecap'
  ...
  [
    { path: '/onboarding', element: <Onboarding /> },
    {
      ...
      children: [
        ...
        { path: 'recap', element: <Navigate to="/recap/review" replace /> },
        { path: 'recap/review', element: <DragonSeekingRecap /> },
