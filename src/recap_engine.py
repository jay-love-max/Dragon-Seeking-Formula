...
from render_fragments import render_theme_runtime, render_theme_styles, render_vendor_head
...
<body class="min-h-screen pb-12">
    ...
    html_content = html_content.replace("__VENDOR_HEAD__", render_vendor_head()).replace("__THEME_STYLES__", render_theme_styles()).replace("__THEME_RUNTIME__", render_theme_runtime())
